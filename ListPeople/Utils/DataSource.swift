...
public class DataSource {
    ...
    private struct Constants {
        static let peopleCountRange: ClosedRange<Int> = 1...200 // lower bound must be > 0
...
extension DataSource {
    class func hardRefresh(completionHandler: @escaping FetchCompletionHandler) {
        people = []
        fetch(next: nil, completionHandler)
    }
}
